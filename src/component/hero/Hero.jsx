...
const Hero = () => {
  return (
    ...
    <div class="banner-bg">
        <img src="https://gainbot.io/assets/files/banner-bg.png" alt="Background Image"/>
    </div>
        ...
        <div class="row align-items-center gy-5">
            <div class="col-lg-7">
                <div class="banner-content">
                    ...
                    <div class="d-flex justify-content-between align-items-end gap-lg-4 gap-2">
                        <div class="d-flex justify-content-start align-items-center flex-lg-nowrap flex-wrap-reverse gap-4">
                            <a href="register.html" class="i-btn banner-btn">Start Investing <i class="bi bi-arrow-right-short"></i></a>
                            <div class="video-pluse">
                                <span></span>
                                <span></span>
                                <span></span>
                                <a data-fancybox href="#"><i class="bi bi-play-fill"></i></a>
                            </div>
                        </div>
                ...
                <ul class="banner-features mb-60">
                    <li><span><i class="bi bi-bar-chart"></i></span>Fast Trading</li>
                    <li><span><i class="bi bi-shield-check"></i></span>Secure &amp; Reliable</li>
                    <li><span><i class="bi bi-arrow-repeat"></i></span>Continuous Market Updates</li>
                </ul>
                ...
                <div class="providers">
                    <div class="row row-cols-lg-4 row-cols-md-4 row-cols-sm-4 row-cols-2 justify-content-lg-start justify-content-center align-items-center g-4">
                        <div class="col">
                            <img src="https://gainbot.io/assets/files/banner-coin1.png" alt="banner-coin1"/>
                        </div>
                        <div class="col">
                            <img src="https://gainbot.io/assets/files/banner-coin2.png" alt="banner-coin2"/>
                        </div>
                        <div class="col">
                            <img src="https://gainbot.io/assets/files/banner-coin3.png" alt="banner-coin3"/>
                        </div>
                        <div class="col">
                            <img src="https://gainbot.io/assets/files/banner-coin1.png" alt="banner-coin4"/>
                        </div>
                    </div>
                </div>
            </div>
            <div class="offset-lg-1 col-lg-4">
                <img src="https://gainbot.io/assets/files/WCukvTg8vUHQm9XW.jpg" alt="Main Image"/>
            </div>
        </div>
    </div>
</div>
