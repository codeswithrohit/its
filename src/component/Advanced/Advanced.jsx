            ...
            <div class="col-xl-5 col-lg-7 col-md-9">
              <div class="section-title text-center text-white mb-10">
                ...
                <p className="text-white" >
                  ...
                  trading strategy. Stay ahead in the dynamic world of crypto
                  with FinFunder&#039;s insightful exchange tools.
                </p>
              </div>
            </div>
          </div>
              ...
              <div class="table-container">
                <table id="myTable" class="table">
                  ...
                  <tbody>
                    <tr>
                      <td data-label="Name">
                        <a href="login.html" class="our-currency-item">
                      ...
                      <td data-label="Action">
                        <div class="action">
                          ...
                          <a
                            href="login.html"
                            class="i-btn btn--sm btn--lite--secondary capsuled"
                          >
                            Practice
                          </a>
                        </div>
